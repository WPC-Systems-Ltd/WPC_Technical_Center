...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/motion/EMotion.webp').default} alt="EMotion" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/motion/Emotion_IO.webp').default} alt="EMotion I/O" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/motion/EMotion_size.webp').default} alt="EMotion Dimensions" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/motion/EMotion_install.webp').default} alt="EMotion Installation" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/motion/EMotion_wiring.webp').default} alt="EMotion Wiring" width="60%" />
</div>
