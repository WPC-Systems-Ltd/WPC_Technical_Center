...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/wpc-gstack-rio-manager/gstackRIO_manager_download_page.webp').default} alt="gstackRIO_manager_download_page" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/wpc-gstack-rio-manager/runtime2019_download_page.webp').default} alt="runtime2019_download_page" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/wpc-gstack-rio-manager/compactRIO_15_5_download_page.webp').default} alt="compactRIO_15_5_download_page" width="60%" />
</div>
...
1.  Click **"More info"**.
    ...
    <div style={{textAlign: 'center'}}>
      <img src={require('@site/static/img/wpc-gstack-rio-manager/windows_protection_1.webp').default} alt="windows_protection_1" width="60%" />
    </div>

2.  Click **"Run anyway"**.

    <div style={{textAlign: 'center'}}>
      <img src={require('@site/static/img/wpc-gstack-rio-manager/windows_protection_2.webp').default} alt="windows_protection_2" width="60%" />
    </div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/wpc-gstack-rio-manager/windows_firewall.webp').default} alt="windows_firewall" width="60%" />
</div>

Once opened, gStack-RIO Manager will automatically search for gStackRIO controllers.

<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/wpc-gstack-rio-manager/gstackRIO_manager_search.webp').default} alt="gstackRIO_manager_search" width="60%" />
</div>
