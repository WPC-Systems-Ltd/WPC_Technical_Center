...
Clicking on the intersections on the grid allows you to toggle between Connect or Disconnect status.

| Button             | Function                                     |
| :--------------- | :--------------------------------------- |
| **Start**        | Enable the Matrix control function and execute current connection settings. |
| **Stop**         | Stop control.                               |
| **Disconnect All** | Immediately disconnect all cross-point connections.               |
