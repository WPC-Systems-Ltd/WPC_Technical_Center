...
sidebar_position: 15
sidebar_label: 'Relay'
description: "The Relay panel allows users to control the switch status of relays on the device and set the initial power-up state. | Product Name | Port | | :------------..."
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/wpc_device_manager/testPanel/WDM_testPanel_relay.webp').default} alt="WDM_testPanel_relay" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/wpc_device_manager/testPanel/WDM_testPanel_relay_powe_state.webp').default} alt="WDM_testPanel_relay_powe_state" width="60%" />
</div>
