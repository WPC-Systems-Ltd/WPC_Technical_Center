...
keywords: [Ethernet Device Functions, WPC software, Geco Manager, Device Manager, test panel, configuration guide]
---
## Refresh
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/wpc_device_manager/ethernet/WDM_Ethan_refresh.webp').default} alt="WDM_Ethan_refresh" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/wpc_device_manager/ethernet/WDM_Ethan_pinout.webp').default} alt="WDM_Ethan_pinout" width="60%" />
</div>

<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/wpc_device_manager/ethernet/WDM_Ethan_pinout1.webp').default} alt="WDM_Ethan_pinout1" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/wpc_device_manager/ethernet/WDM_Ethan_set_alias.webp').default} alt="WDM_Ethan_set_alias" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/wpc_device_manager/ethernet/WDM_Ethan_set_ip.webp').default} alt="WDM_Ethan_set_ip" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/wpc_device_manager/ethernet/WDM_Ethan_set_gateway.webp').default} alt="WDM_Ethan_set_gateway" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/wpc_device_manager/ethernet/WDM_Ethan_reboot.webp').default} alt="WDM_Ethan_reboot" width="60%" />
</div>
...
1.  Click the **"Update Firmware"** button.
    ...
    <div style={{textAlign: 'center'}}>
      <img src={require('@site/static/img/wpc_device_manager/ethernet/WDM_Ethan_update_firmware.webp').default} alt="WDM_Ethan_update_firmware" width="60%" />
    </div>
...
2.  Select the corresponding firmware file (`.bin`) from the file browser.
    ...
    <div style={{textAlign: 'center'}}>
      <img src={require('@site/static/img/wpc_device_manager/ethernet/WDM_Ethan_choose_bin.webp').default} alt="WDM_Ethan_choose_bin" width="60%" />
    </div>
...
3.  A confirmation window will pop up; click **"OK"** to start writing.
    ...
    <div style={{textAlign: 'center'}}>
      <img src={require('@site/static/img/wpc_device_manager/ethernet/WDM_Ethan_keep_updating.webp').default} alt="WDM_Ethan_keep_updating" width="60%" />
    </div>

4.  Wait for the progress bar to complete.

    <div style={{textAlign: 'center'}}>
      <img src={require('@site/static/img/wpc_device_manager/ethernet/WDM_Ethan_updating.webp').default} alt="WDM_Ethan_updating" width="60%" />
    </div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/wpc_device_manager/ethernet/WDM_Ethan_sntp.webp').default} alt="Set SNTP" width="60%" />
</div>
