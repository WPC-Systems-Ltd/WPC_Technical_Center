...
<div className="gs-card-grid">
  <a href="/docs/ethan" className="theme-doc-card gs-card">
  ...
  <a href="/docs/usb-daq" className="theme-doc-card gs-card">
  ...
  <a href="/docs/wifi-daq" className="theme-doc-card gs-card">
  ...
  <a href="/docs/stem" className="theme-doc-card gs-card">
