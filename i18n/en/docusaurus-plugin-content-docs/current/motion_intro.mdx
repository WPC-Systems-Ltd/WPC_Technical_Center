...
<div className="gs-card-grid">
  <a href="/WPC_Technical_Center/docs/Motion/edrivest/intro" className="theme-doc-card gs-card">
    ...
    <p>Equipped with a network interface, it directly connects to two-phase stepper motors, encoders, and limit switches, achieving position and speed control without an additional motion card.</p>
  </a>
  <a href="/WPC_Technical_Center/docs/Motion/edrivesrv/intro" className="theme-doc-card gs-card">
    ...
    <p>Supports Panasonic A6 series servo motors, with up to 48V DC power and a maximum output power of 400W, suitable for high-precision motion control.</p>
  </a>
  <a href="/WPC_Technical_Center/docs/Motion/emotion/products" className="theme-doc-card gs-card">
    ...
    <p>**Four-axis Motion Control Card**</p>
    <p>Supports various renowned brands of servo drivers (Yaskawa, Mitsubishi, Delta, Panasonic), offering dedicated and universal daughter boards for rapid integration into existing systems.</p>
  </a>
</div>
