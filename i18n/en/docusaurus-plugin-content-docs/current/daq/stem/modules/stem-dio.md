...
This module provides 12-channel Digital Input (DI) and 12-channel Digital Output (DO) functions, suitable for 24V industrial control adapter.
...
| **Digital Output (DO)** | 12 ch, Supports NPN/PNP, Optocoupler Isolation (24V) |
| **Digital Input (DI)** | 12 ch, Supports NPN/PNP, Optocoupler Isolation (24V) |
...
This module supports Sinking and Sourcing wiring modes, which need to be configured through the resistors on the adapter board.


### Sinking Out + Sourcing In

*   ⚠️ Install **Top Row** Resistors
...
*   ⚠️ Install **Bottom Row** Resistors
