...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/daq/stem/motion_card_specefic_board_Delta_ASDA_B2.webp').default} alt="Delta B2 Board" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/daq/stem/motion_card_specefic_board_Delta_ASDA_A2.webp').default} alt="Delta A2 Board" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/daq/stem/motion_card_specefic_board_Yaskawa_SGDV_SGD7.webp').default} alt="Yaskawa Board" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/daq/stem/motion_card_specefic_board_Panasonic_A4_A5_A6.webp').default} alt="Panasonic Board" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/daq/stem/motion_card_specefic_board_Mitsibishi_MR_J4_JE.webp').default} alt="Mitsubishi J4 Board" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/daq/stem/motion_card_specefic_board_Mitsibishi_MR_J2S.webp').default} alt="Mitsubishi J2S Board" width="60%" />
</div>
