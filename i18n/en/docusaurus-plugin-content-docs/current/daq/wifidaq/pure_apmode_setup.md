...
<img src={require('@site/static/img/daq/wifi-daq/wifi-daq-change-domain-ip.webp').default} alt="AP Mode" width="600" />
...
<img src={require('@site/static/img/daq/wifi-daq/wifi-daq-ap-mode-pc-connect.webp').default} alt="Connect to WIFI-DAQ" width="400" />
...
<img src={require('@site/static/img/daq/wifi-daq/wifi-daq-browser.webp').default} alt="Web Config" width="600" />
