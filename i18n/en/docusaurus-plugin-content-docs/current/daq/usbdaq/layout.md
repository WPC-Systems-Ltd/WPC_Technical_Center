...
<div style={{textAlign: 'center'}}><img src={require('@site/static/img/daq/usb-daq/USBDAQD_layout.png').default} alt="USB-DAQ-D Series Dimensions" width="60%" /></div>


### **Applicable to USB-DAQ-TD**
---

<div style={{textAlign: 'center'}}><img src={require('@site/static/img/daq/usb-daq/USBDAQTD_Layout.png').default} alt="USB-DAQ-TD Series Dimensions" width="60%" /></div>
