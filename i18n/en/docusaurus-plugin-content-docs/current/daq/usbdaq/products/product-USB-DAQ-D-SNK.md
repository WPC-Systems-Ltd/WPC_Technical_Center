...
> ⚠️ Requires external 24V power.

### Pinout
---

<div style={{textAlign: 'center'}}><img src="/WPC_Technical_Center/img/daq/usb-daq/USBDAQDSNK_pinout.png" alt="USB-DAQ-D-SNK Pinout" width="60%" /></div>
...
> 💡 WPC has not yet released PNP type USB I/O hardware.
...
<div style={{textAlign: 'center'}}><img src="/WPC_Technical_Center/img/daq/usb-daq/USBDAQDSNK_DO_wiring.png" alt="DO Wiring" width="60%" /></div>
...
<div style={{textAlign: 'center'}}><img src="/WPC_Technical_Center/img/daq/usb-daq/USBDAQDSNK_DI_wiring.png" alt="DI Wiring" width="60%" /></div>
