...
Ethan-A2 provides **8-channel 24-bit high-precision analog input**, with a sampling rate of up to **10kHz** and an input range of **Â±13.75V**, suitable for precision applications requiring high-resolution measurement.
