...
1.  Download [WPC Stand-Alone Python Editor](https://www.wpc.com.tw/stand-alone-python-editor.html).
...
1.  Open WPC Stand-Alone Python Editor (or your preferred IDE).
2.  Download example code from the [official example page](https://wpc-systems-ltd.github.io/WPC_Stand-alone_Python_release/examples/PYCO_WIFI/System/get_system_info.html).
...
:::tip More Examples
👉 Check out more example codes [PYCO Series Example Codes](https://wpc-systems-ltd.github.io/WPC_Stand-alone_Python_release/examples_PYCO_WIFI_MINI_AO.html)
:::
