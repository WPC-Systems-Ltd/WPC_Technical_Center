...
sidebar_position: 2
description: "When the PYCO development board is powered on, it will first execute boot.py, followed by main.py. - boot.py is typically used for system or environment init..."
keywords: [Startup Sequence, WPC, technical documentation, specifications]
---
# Startup Sequence
