...
description: 16ch Digital Potentiometer Module Specifications and Pinout
---

# 16ch Digital Potentiometers Module

This module provides 16 channels of digital potentiometers, allowing resistance values to be controlled via software.
...
| **Output Range** | 10K Ω / 50K Ω / 100K Ω |
| **Update Rate** | 100 Hz |
...
<div style={{textAlign: 'center'}}>
  <img src="/img/embedded-system/geco/geco_page_11_X156.jpg" alt="DPOT Module Appearance" width="60%" />
</div>

### Pinout

<div style={{textAlign: 'center'}}>
  <img src="/img/embedded-system/geco/geco_page_12_X162.png" alt="DPOT Module Pinout" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src="/img/embedded-system/geco/geco_page_14_X175.png" alt="DIO ctrl." width="60%" />
</div>


<div style={{textAlign: 'center'}}>
  <img src="/img/embedded-system/geco/geco_page_14_X177.png" alt="DIO ctrl." width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src="/img/embedded-system/geco/geco_page_15_X183.png" alt="Paralleling or Stacking." width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src="/img/embedded-system/geco/geco_page_15_X185.png" alt="Voltage diff. across a resistor." width="60%" />
</div>
