...
description: 12ch DI / 12ch DO Mixed Module Specifications and Pinout
---

# 12ch DI / 12ch DO Module

This module integrates 12-channel digital inputs and 12-channel digital outputs, suitable for mixed signal requirements.
...
| **DI Channels** | 12 ch (NPN/PNP) |
| **DO Channels** | 12 ch (NPN/PNP) |
| **Isolation** | Opto-isolated (24V) |

## 2. Appearance and Pinout

<div style={{textAlign: 'center'}}>
  <img src="/img/embedded-system/geco/geco_page_24_X244.jpg" alt="DIO Module Appearance" width="60%" />
</div>

### Pinout

<div style={{textAlign: 'center'}}>
  <img src="/img/embedded-system/geco/geco_page_25_X250.png" alt="DIO Module Pinout" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src="/img/embedded-system/geco/geco_page_19_X210.png" alt="Sinking Output" width="60%" />
</div>

### Sourcing Output

<div style={{textAlign: 'center'}}>
  <img src="/img/embedded-system/geco/geco_page_19_X213.png" alt="Sourcing Output" width="60%" />
</div>

:::caution
*   **Sinking Output**: Install upper row resistors, output is 0V, input end must be common anode (24V).
*   **Sourcing Output**: Install lower row resistors, output is 24V, input end must be common cathode (0V).
:::
