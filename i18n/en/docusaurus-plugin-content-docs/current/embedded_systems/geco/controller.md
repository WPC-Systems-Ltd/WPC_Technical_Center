...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/embedded-system/geco/geco_controller_support.webp').default} alt="geco_controller_support" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/embedded-system/geco/geco_uno_controller1.webp').default} alt="geco_uno_controller1" width="60%" />
</div>

**GECO UNO Series Layout**
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/embedded-system/geco/geco_controller_layout.webp').default} alt="geco_controller_layout" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/embedded-system/geco/geco_uno_db9_controller.webp').default} alt="GECO UNO DB9" width="60%" />
</div>

**DB9 Connector Pin Definitions**
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/embedded-system/geco/geco_uno_db9_controller_pin_assignment.webp').default} alt="geco_uno_db9_controller_pin_assignment" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/embedded-system/geco/geco_uno_27_controller.webp').default} alt="geco_uno_27_controller" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/embedded-system/geco/NI_sbRIO_9606.webp').default} alt="NI_sbRIO_9606" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/embedded-system/geco/NI_sbRIO_9606.webp').default} alt="sbRIO-9607" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/embedded-system/geco/NI_sbRIO_9627.webp').default} alt="NI_sbRIO_9627" width="60%" />
</div>
