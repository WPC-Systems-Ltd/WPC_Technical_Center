...
keywords: [8ch High Common Mode Voltage HCMV Amplifier, signal conditioner, signal isolation, amplifier, filter, load cell]
---
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/signal-condition/8ch_HCMV.webp').default} alt="8ch_HCMV" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/signal-condition/8ch_HCMV_pinout.webp').default} alt="8ch_HCMV_pinout" width="60%" />
</div>
...
### Connection Diagram
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/signal-condition/8ch_HCMV_connection_diagram.webp').default} alt="8ch_HCMV_connection_diagram" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/signal-condition/8ch_HCMV_power_ref.webp').default} alt="8ch_HCMV_power_ref" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/signal-condition/8ch_HCMV_high_voltage_expansion.webp').default} alt="8ch_HCMV_high_voltage_expansion" width="60%" />
</div>
