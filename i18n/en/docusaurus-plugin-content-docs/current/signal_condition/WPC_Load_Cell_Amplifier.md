...
keywords: [1ch Load Cell Amplifier, signal conditioner, signal isolation, amplifier, filter, load cell]
---
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/signal-condition/Load_Cell_Amplifier.webp').default} alt="Load_Cell_Amplifier" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/signal-condition/Load_Cell_Amplifier_pinout.webp').default} alt="Load_Cell_Amplifier_pinout" width="60%" />
</div>

## Gain Selection

<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/signal-condition/Load_Cell_Amplifier_gain_selection.webp').default} alt="Load_Cell_Amplifier_gain_selection" width="60%" />
</div>
---
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/signal-condition/Load_Cell_Amplifier_connection.webp').default} alt="Load_Cell_Amplifier_connection" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/signal-condition/Load_Cell_Amplifier_grounding.webp').default} alt="Load_Cell_Amplifier_grounding" width="80%" />
</div>
---
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/signal-condition/Load_Cell_Amplifier_noise.webp').default} alt="Load_Cell_Amplifier_noise" width="60%" />
</div>

### Correlation

<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/signal-condition/Load_Cell_Amplifier_correlation.webp').default} alt="Load_Cell_Amplifier_correlation" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/signal-condition/Load_Cell_Amplifier_test.webp').default} alt="Load_Cell_Amplifier_test" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/signal-condition/Load_Cell_Amplifier_dimension.webp').default} alt="Load_Cell_Amplifier_dimension" width="60%" />
</div>

<div style={{textAlign: 'center'}}>
  <img src={require('@site/static/img/signal-condition/Load_Cell_Amplifier_dimension1.webp').default} alt="Load_Cell_Amplifier_dimension1" width="60%" />
</div>
