...
:::tip[需要更多建議？]
如果您不確定哪種模組最符合您的應用，請參考 **[產品介紹](./intro.md)** 以了解詳細的機箱架構與控制器配置。
:::
...
:::note[下載與安裝]
請前往 **[gStack-RIO Manager 簡介與安裝](../software/gstack-rio-manager/intro.md)** 頁面，下載管理軟體並確認必要的 LabVIEW Run-time 與 NI VISA 驅動環境。
:::
...
| 開發環境 | 特色簡介 | 詳細教學連結 |
| :------- | :------- | :----------- |
| **LabVIEW** | 提供豐富的 VIs 與 Demo 範例，支援 PC Remote 控制模式。 | [LabVIEW 入門](../driver/gstack-rio-driver/intro.md) |
