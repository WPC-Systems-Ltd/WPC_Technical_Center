...
| 範例程式名稱                   | 描述                                                                |
|:----------------------------  | :----------------------------------------------------------------- |
|WPC Drone - Active.vi          | 啟用無人機                                                          |
|WPC Drone - Read Battery.vi    | 讀取無人機電池的電壓與電流數據                                        |
|WPC Drone - Simple Move.vi     | 完整的無人機移動流程 (包含模式設定 → 啟動無人機 → 起飛 → 移動 → 降落)   |
|WPC Drone - Takeoff.vi         | 基礎無人機起降流程 (包含模式設定 → 啟動無人機 → 起飛 → 降落)            |