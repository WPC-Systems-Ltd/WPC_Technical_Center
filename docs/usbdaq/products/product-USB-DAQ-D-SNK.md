...
<div style={{textAlign: 'center'}}><img src="/img/daq/usb-daq/usb-daq-d-snk-pinout.png" alt="USB-DAQ-D-SNK 腳位圖" width="60%" /></div>
...
<div style={{textAlign: 'center'}}><img src="/img/daq/usb-daq/d-snk-do-wiring.png" alt="DO 接線圖" width="60%" /></div>

> 下圖為 DI 等效電路圖，所有 DI 通道內部都直接共陽極 24V，因此若將 DI 輸入 pin 腳連接到 0V 則可以從該 DI 腳位讀取到 TRUE。DI 腳位也可以透過 DO 腳位進行 loop-back 測試。

<div style={{textAlign: 'center'}}><img src="/img/daq/usb-daq/d-snk-di-wiring.png" alt="DI 接線圖" width="60%" /></div>
