...
<div style={{textAlign: 'center'}}>
  <img src="/img/embedded-system/pyco/pyco-wifi-mini-ai.png" alt="PYCO WIFI MINI AI 外觀" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src="/img/embedded-system/pyco/pyco-wifi-mini-pinout.png" alt="PYCO WIFI MINI AI 腳位圖" width="60%" />
</div>
