...
<div style={{textAlign: 'center'}}><img src="/WPC_Technical_Center/img/daq/usb-daq/usb-daq-td-pinout.png" alt="USB-DAQ-TD 腳位圖" width="60%" /></div>
...
<div style={{textAlign: 'center'}}><img src="/WPC_Technical_Center/img/daq/usb-daq/thermocouple-connector.png" alt="熱電偶接線圖" width="60%" /></div>
