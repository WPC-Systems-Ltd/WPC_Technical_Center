...
keywords: [變更 WiFi 設定 使用 WDM, 資料擷取, DAQ卡, 量測硬體, WPC DAQ, 資料擷取系統]
---
# 變更 Wi-Fi 設定 (使用 WDM)
...
<img src="/WPC_Technical_Center/img/daq/wifi-daq/wifi-daq-go-to-ap-mode.webp" alt="Go to AP Mode" width="600" />

## 步驟 2：確認執行

WDM 將跳出視窗詢問是否確認要切換至 AP 模式。請點擊 **OK** 繼續。

<img src="/WPC_Technical_Center/img/daq/wifi-daq/wifi-daq-keep-to-ap-mode.webp" alt="Keep AP Mode" width="600" />
...
<img src="/WPC_Technical_Center/img/daq/wifi-daq/wdm-auto-connect-to-wifidaq.webp" alt="Auto Connect to WIFI-DAQ" width="600" />

## 步驟 4：自動進入設定頁面

點擊 OK 後，WDM 會自動開啟網頁瀏覽器，並跳轉至 WIFI-DAQ 的設定頁面 (`192.168.4.1`)。

<img src="/WPC_Technical_Center/img/daq/wifi-daq/wdm-open-wifi-configuration-page.webp" alt="Open WIFI Configuration Page" width="600" />
