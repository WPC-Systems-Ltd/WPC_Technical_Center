...
<div style={{textAlign: 'center'}}>
  <img src="/WPC_Technical_Center/img/wpc-geco-manager/download-page.png" alt="GECO Manager 下載頁面" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src="/WPC_Technical_Center/img/wpc-geco-manager/geco_manager_page3_X63.png" alt="LabVIEW Runtime 下載頁面" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src="/WPC_Technical_Center/img/wpc-geco-manager/geco_manager_page7_X94.png" alt="GECO Manager 啟動畫面" width="60%" />
</div>
