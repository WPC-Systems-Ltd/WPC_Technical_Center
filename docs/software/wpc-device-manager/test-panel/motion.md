...
<div style={{textAlign: 'center'}}>
  <img src="/WPC_Technical_Center/img/wpc_device_manager/testPanel/motion.png" alt="Motion Test Panel" width="60%" />
</div>
...
| 圖示                                                                               | 功能說明                                                  |
| :--------------------------------------------------------------------------------- | :-------------------------------------------------------- |
| <img src="/WPC_Technical_Center/img/wpc_device_manager/testPanel/open-config-panel.png" width="30" />   | **Open Configuration Panel**：開啟運動控制 I/O 設定面板。 |
| <img src="/WPC_Technical_Center/img/wpc_device_manager/testPanel/servo-on-off.png" width="30" />       | **Servo On/Off**：切換伺服激磁狀態。                      |
| <img src="/WPC_Technical_Center/img/wpc_device_manager/testPanel/halt.png" width="30" />               | **Halt**：緊急暫停馬達運轉。                              |
| <img src="/WPC_Technical_Center/img/wpc_device_manager/testPanel/move.png" width="30" />               | **Interactive Control**：開啟互動式移動控制面板。         |
| <img src="/WPC_Technical_Center/img/wpc_device_manager/testPanel/reset.png" width="30" />              | **Reset Position**：重置邏輯位置計數為 0。                |
...
<div style={{textAlign: 'center'}}>
  <img src="/WPC_Technical_Center/img/wpc_device_manager/testPanel/motion-config.png" alt="Motion I/O config panel" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src="/WPC_Technical_Center/img/wpc_device_manager/testPanel/simple-move.png" alt="Simple Move" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src="/WPC_Technical_Center/img/wpc_device_manager/testPanel/find-ref.png" alt="Find Ref" width="60%" />
</div>
