...
sidebar_position: 6
sidebar_label: 'DO'
description: "DO (Digital Output) 面板提供使用者控制數位輸出訊號的狀態。透過此介面，您可以手動切換各通道的高低電位輸出，並設定上電初始狀態。 本功能支援具備數位輸出 (DO) 功能的裝置。請依照您的裝置型號，確認對應的連接埠 (Port) 編號： | 產品名稱 | 連接埠 | | :--..."
...
<div style={{textAlign: 'center'}}>
  <img src="/WPC_Technical_Center/img/wpc_device_manager/testPanel/WDM_testPanel_do.webp" alt="WDM_testPanel_do" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src="/WPC_Technical_Center/img/wpc_device_manager/testPanel/WDM_testPanel_do_power_state.webp" alt="WDM_testPanel_do_power_state" width="60%" />
</div>
