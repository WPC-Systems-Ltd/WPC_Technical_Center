...
*   **USB 裝置**：將滑鼠游標移至 **"My Computer"** 區域，按右鍵選擇 **"Refresh My Computer"**。
    ...
    <div style={{textAlign: 'center'}}>
      <img src="/WPC_Technical_Center/img/wpc_device_manager/refresh-my-computer.png" alt="重新整理 USB 裝置" width="60%" />
    </div>

*   **網路裝置**：將滑鼠游標移至 **"Network"** 區域，按右鍵選擇 **"Refresh Network"**。

    <div style={{textAlign: 'center'}}>
      <img src="/WPC_Technical_Center/img/wpc_device_manager/refresh-network.png" alt="重整網路裝置" width="60%" />
    </div>
...
<div style={{textAlign: 'center'}}>
  <img src="/WPC_Technical_Center/img/wpc_device_manager/add-simulated-device.png" alt="新增模擬裝置" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src="/WPC_Technical_Center/img/wpc_device_manager/toggle-blink.png" alt="辨識網路裝置 LED" width="60%" />
</div>
