  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          type: 'doc',
          docId: 'Drone/drone-starter-guide',
          position: 'left',
          label: '無人機',
        },
        {
        ...
        {
          type: 'doc',
          docId: 'signal_condition/signal_condition-starter-guide',
          position: 'left',
          label: '訊號調節器',
        },
        {
        ...
        },
        {
          ...
          value: `
            <div class="mobile-social-links">
              ...
              <a href="https://www.facebook.com/WpcSystemsLtd/" aria-label="Facebook" target="_blank">
              ...
              <a href="https://www.youtube.com/@wpcsystemsltd.8927" aria-label="YouTube" target="_blank">
      ...
      copyright: `
        <div style="display: flex; align-items: center; max-width: var(--ifm-container-width); margin: 0 auto; width: 100%; padding: 0 1rem; color: var(--ifm-color-content-secondary); font-size: 0.9rem;">
          ...
          <a href="https://github.com/WPC-Systems-Ltd" target="_blank" rel="noopener noreferrer" style="color: inherit; display: flex; align-items: center; gap: 0.4rem; transition: color 0.2s; text-decoration: none;">
            ...
            <a href="https://www.facebook.com/WpcSystemsLtd/" aria-label="Facebook" target="_blank" style="color: inherit; display: flex; align-items: center; gap: 0.4rem; transition: color 0.2s; text-decoration: none;">
