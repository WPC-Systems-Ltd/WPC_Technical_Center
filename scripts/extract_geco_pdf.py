...
pdf_path = r"d:\Synology\github\WPC_Technical_Center\Notion\WPC_GECO_User_Guide.pdf"
output_dir = r"d:\Synology\github\WPC_Technical_Center\static\img\embedded-system\geco"
text_output_path = r"d:\Synology\github\WPC_Technical_Center\Notion\geco_raw_text.md"
            ...
            for obj in xObject:
                if xObject[obj]['/Subtype'] == '/Image':
                    ...
                    if xObject[obj]['/Filter'] == '/DCTDecode':
                        img_path = os.path.join(output_dir, f"geco_page_{i+1}_{obj[1:]}.jpg")
                        ...
                        try:
                           ...
                           img_path = os.path.join(output_dir, f"geco_page_{i+1}_{obj[1:]}.png")
                           img.save(img_path)
                        except:
